/*
  Modified version of https://github.com/npm/npm/blob/master/lib/install.js
...
var npm = require("npm/lib/npm.js")
  ...
  , readInstalled = require("npm/node_modules/read-installed")
  , log = require("npm/node_modules/npmlog")
  , path = require("path")
  , fs = require("npm/node_modules/graceful-fs")
  , writeFileAtomic = require("npm/node_modules/write-file-atomic")
  , cache = require("npm/lib/cache.js")
  , asyncMap = require("npm/node_modules/slide").asyncMap
  , chain = require("npm/node_modules/slide").chain
  , url = require("url")
  , mkdir = require("npm/node_modules/mkdirp")
  , lifecycle = require("npm/lib/utils/lifecycle.js")
  , archy = require("npm/node_modules/archy")
  , npmInstallChecks = require("npm/node_modules/npm-install-checks")
  , sortedObject = require("npm/node_modules/sorted-object")
  , mapToRegistry = require("npm/lib/utils/map-to-registry.js")
  , npa = require("npm/node_modules/npm-package-arg")
  , inflight = require("npm/node_modules/inflight")
  , locker = require("npm/lib/utils/locker.js")
  , lock = locker.lock
  , unlock = locker.unlock
  , warnStrict = require("npm/lib/utils/warn-deprecated.js")("engineStrict")
  , warnPeers = require("npm/lib/utils/warn-deprecated.js")("peerDependencies")
    ...
    if (!args.length) {
      ...
      if (npm.config.get("global")) args = ["."]
        ...
        Object.keys(data.peerDependencies || {}).forEach(function (dep) {
          // Don't install pimatic peer dependendy
          if (dep.indexOf('pimatic') === 0) {
            warnPeers([
              "The pimatic plugin " + data.name + " is maybe not compatible with your " +
              "pimatic version."
            ], dep+","+data.name)
            return;
          }
  ...
  chain(
    ...
    , function X (er) {
      ...
      readDependencies(context, targetFolder, opt, function (er, data, wrap) {
        ...
        // Warn for icompatibility
        peerDeps.forEach(function (pd){
          if (pd.indexOf('pimatic') === 0) {
            warnPeers([
              "The pimatic plugin " + data.name + " is maybe not compatible with your " +
              "pimatic version."
            ], pd+","+data.name)
        ...
        // Don't install pimatic peer dependency:
        peerDeps = peerDeps.filter( function(pd) { return pd.indexOf('pimatic') !== 0; } );
